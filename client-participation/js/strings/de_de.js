...
s.participantHelpGroupsText = "Cada una de tus respuestas <span style='font-weight: 700;'>te acerca a algunas personas y te aleja de otras</span>, permitiendo agrupar a la gente que opina de manera similar. Hacé click en un grupo para ver los puntos de vista que comparten sus miembros <a style='font-weight: 700; cursor: pointer; text-decoration: underline' id='helpTextGroupsExpand'>...más</a>";
s.participantHelpGroupsNotYetText = "La visualización aparecerá cuando 7 participantes votan";
s.helpWhatAreGroupsDetail = "<p>Probablemente has visto los 'productos recomendados' en los sitios de compras, o las 'películas recomendadas' de los servicios de streaming. Esos servicios usan algoritmos para agruparte con gente que compra y mira cosas similares y entonces mostrarte cosas compradas o miradas por ellos. Esto funciona de la misma forma, pero de manera abierta.</p> <p>Cuando votás en un comentario de este cuestionario pasás a formar parte del grupo de gente que votó de manera similar. Aquí abajo puedes explorar los grupos. Hacé click en un grupo para ver cuáles opiniones lo unen y cuáles lo separan de los demás. ¿Estás cerca de la gente que esperabas?</p>";
